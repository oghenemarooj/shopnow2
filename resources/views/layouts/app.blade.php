...
<head>
    ...
    <!-- Site title -->
    <title>Shopnow - @yield('title') </title>
    <!-- Favicon -->
    ...
    <!-- helper class css -->
    <link href="/home_assets/css/helper.min.css" rel="stylesheet">
    <!-- Plugins CSS -->
    <link href="/home_assets/css/plugins.css" rel="stylesheet">
    <!-- Main Style CSS -->
    <link href="/home_assets/css/style.css" rel="stylesheet">
    <link href="/home_assets/css/skin-default.css" rel="stylesheet" id="galio-skin">
</head>
...
<body>
        ...
        <div class="color-switcher-inner">
            ...
            <div class="switcher-panel-item bg">
                ...
                <ul class="nav flex-wrap bgbody-style bg-pattern">
                    <li><img src="/home_assets/img/bg-panel/bg-pettern/1.png" alt="Pettern"></li>
                    <li><img src="/home_assets/img/bg-panel/bg-pettern/2.png" alt="Pettern"></li>
                    <li><img src="/home_assets/img/bg-panel/bg-pettern/3.png" alt="Pettern"></li>
                    <li><img src="/home_assets/img/bg-panel/bg-pettern/4.png" alt="Pettern"></li>
                    <li><img src="/home_assets/img/bg-panel/bg-pettern/5.png" alt="Pettern"></li>
                    <li><img src="/home_assets/img/bg-panel/bg-pettern/6.png" alt="Pettern"></li>
                </ul>
            </div>
            ...
            <div class="switcher-panel-item bg">
                ...
                <ul class="nav flex-wrap bgbody-style bg-img">
                    <li><img src="/home_assets/img/bg-panel/bg-img/01.jpg" alt="Images"></li>
                    <li><img src="/home_assets/img/bg-panel/bg-img/02.jpg" alt="Images"></li>
                    <li><img src="/home_assets/img/bg-panel/bg-img/03.jpg" alt="Images"></li>
                    <li><img src="/home_assets/img/bg-panel/bg-img/04.jpg" alt="Images"></li>
                    <li><img src="/home_assets/img/bg-panel/bg-img/05.jpg" alt="Images"></li>
                    <li><img src="/home_assets/img/bg-panel/bg-img/06.jpg" alt="Images"></li>
                </ul>
            </div>
        </div>
    </div>
                                        ...
                                        <li>
                                            <div class="dropdown header-top-dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="myaccount">
                                                    ...
                                                    <a onclick="logout()" class="dropdown-item" href="{{route('logout')}}">Logout</a>
                                                    @endauth
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3">
                            <div class="brand-logo">
                                <a href="index.html">
                                    <img src="/home_assets/img/logo/logo.png" alt="brand logo">
                                </a>
                            </div>
                        </div> <!-- end logo area -->
                        <div class="col-lg-9">
                                ...
                                <div class="header-middle-block">
                                    ...
                                    <div class="header-mini-cart">
                                        ...
                                        <ul class="cart-list">
                                            <li>
                                                <div class="cart-img">
                                                    <a href="product-details.html"><img src="/home_assets/img/cart/cart-1.jpg" alt=""></a>
                                                </div>
                                                <div class="cart-info">
                                            ...
                                            <li>
                                                <div class="cart-img">
                                                    <a href="product-details.html"><img src="/home_assets/img/cart/cart-2.jpg" alt=""></a>
                                                </div>
                                                <div class="cart-info">
                ...
                <div class="container">
                    <div class="footer-bottom-wrap">
                        ...
                        <div class="payment-method-img">
                            <img src="/home_assets/img/payment.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-5">
                                <div class="product-large-slider slick-arrow-style_2 mb-20">
                                    <div class="pro-large-img">
                                        <img src="/home_assets/img/product/product-details-img1.jpg" alt="" />
                                    </div>
                                    <div class="pro-large-img">
                                        <img src="/home_assets/img/product/product-details-img2.jpg" alt=""/>
                                    </div>
                                    <div class="pro-large-img">
                                        <img src="/home_assets/img/product/product-details-img3.jpg" alt=""/>
                                    </div>
                                    <div class="pro-large-img">
                                        <img src="/home_assets/img/product/product-details-img4.jpg" alt=""/>
                                    </div>
                                    <div class="pro-large-img">
                                        <img src="/home_assets/img/product/product-details-img5.jpg" alt=""/>
                                    </div>
                                </div>
                                <div class="pro-nav slick-padding2 slick-arrow-style_2">
                                    <div class="pro-nav-thumb"><img src="/home_assets/img/product/product-details-img1.jpg" alt="" /></div>
                                    <div class="pro-nav-thumb"><img src="/home_assets/img/product/product-details-img2.jpg" alt="" /></div>
                                    <div class="pro-nav-thumb"><img src="/home_assets/img/product/product-details-img3.jpg" alt="" /></div>
                                    <div class="pro-nav-thumb"><img src="/home_assets/img/product/product-details-img4.jpg" alt="" /></div>
                                    <div class="pro-nav-thumb"><img src="/home_assets/img/product/product-details-img5.jpg" alt="" /></div>
                                </div>
                            </div>
                            <div class="col-lg-7">
    ...
    <script src="/home_assets/js/vendor/modernizr-3.6.0.min.js"></script>
    <!-- Jquery Min Js -->
    <script src="/home_assets/js/vendor/jquery-3.3.1.min.js"></script>
    <!-- Popper Min Js -->
    <script src="/home_assets/js/vendor/popper.min.js"></script>
    <!-- Bootstrap Min Js -->
    <script src="/home_assets/js/vendor/bootstrap.min.js"></script>
    <!-- Plugins Js-->
    <script src="/home_assets/js/plugins.js"></script>
    <!-- Ajax Mail Js -->
    <script src="/home_assets/js/ajax-mail.js"></script>
    <!-- Active Js -->
    <script src="/home_assets/js/main.js"></script>
    <!-- Switcher JS [Please Remove this when Choose your Final Projct] -->
    <script src="/home_assets/js/switcher.js"></script>
