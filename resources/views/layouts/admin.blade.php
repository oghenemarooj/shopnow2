...
<!-- Mirrored from laravel.spruko.com/admitro/Vertical-IconSidedar-Light/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Oct 2020 02:47:51 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <!--Favicon -->
    <link rel="icon" href="/admin_assets/assets/images/brand/favicon.ico" type="image/x-icon" />

    <!--Bootstrap css -->
    <link href="/admin_assets/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- Style css -->
    <link href="/admin_assets/assets/css/style.css" rel="stylesheet" />
    <link href="/admin_assets/assets/css/dark.css" rel="stylesheet" />
    <link href="/admin_assets/assets/css/skin-modes.css" rel="stylesheet" />

    <!-- Animate css -->
    <link href="/admin_assets/assets/css/animated.css" rel="stylesheet" />

    <!--Sidemenu css -->
    <link href="/admin_assets/assets/css/sidemenu.css" rel="stylesheet">

    <!-- P-scroll bar css-->
    <link href="/admin_assets/assets/plugins/p-scrollbar/p-scrollbar.css" rel="stylesheet" />

    <!---Icons css-->
    <link href="/admin_assets/assets/css/icons.css" rel="stylesheet" />

    <!-- Simplebar css -->
    <link rel="stylesheet" href="/admin_assets/assets/plugins/simplebar/css/simplebar.css">

    <!-- Color Skin css -->
    <link id="theme" href="/admin_assets/assets/colors/color1.css" rel="stylesheet" type="text/css" />

    <!-- Switcher css -->
    <link rel="stylesheet" href="/admin_assets/assets/switcher/css/switcher.css">
    <link rel="stylesheet" href="/admin_assets/assets/switcher/demo.css">
...
<body class="app sidebar-mini">
                ...
                <div class="row">
                    <div class="predefined_styles">
                        <div class="swichermainleft">
                            <div class="p-3">
                                <a href="https://laravel.spruko.com/admitro/"
                        ...
                        <div class="swichermainleft">
                            ...
                            <div class="pl-3 pr-3">
                                <a class="btn btn-info btn-block"
                                    href="https://laravel.spruko.com/admitro/Horizontal-Light/index">
                                    Horizontal
                                </a>
    ...
    <div id="global-loader">
        <img src="/admin_assets/assets/images/svgs/loader.svg" alt="loader">
    </div>
    <!--- End Global-loader-->
    <!-- Page -->
    <div class="page">
            ...
            <aside class="app-sidebar">
                <div class="app-sidebar__logo">
                    <a class="header-brand" href="index-2.html">
                        <img src="/admin_assets/assets/images/brand/logo.png" class="header-brand-img desktop-lgo"
                            alt="Admintro logo">
                        <img src="/admin_assets/assets/images/brand/logo1.png" class="header-brand-img dark-logo"
                            alt="Admintro logo">
                        <img src="/admin_assets/assets/images/brand/favicon.png" class="header-brand-img mobile-logo"
                            alt="Admintro logo">
                        <img src="/admin_assets/assets/images/brand/favicon1.png"
                ...
                <div class="app-sidebar__user">
                    <div class="dropdown user-pro-body text-center">
                        <div class="user-pic">
                            <img src="/admin_assets/assets/images/users/2.jpg" alt="user-img"
                ...
                <ul class="side-menu app-sidebar3">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="{{ route('admin.add-product') }}">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"> <path d="M0 0h24v24H0V0z" fill="none" /> <path d="M19 5v2h-4V5h4M9 5v6H5V5h4m10 8v6h-4v-6h4M9 17v2H5v-2h4M21 3h-8v6h8V3zM11 3H3v10h8V3zm10 8h-8v10h8V11zm-10 4H3v6h8v-6z" /> </svg>
                            <span class="side-menu__label">Add Product</span></a>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" href="{{ route('admin.add-category') }}">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"> <path d="M0 0h24v24H0V0z" fill="none" /> <path d="M19 5v2h-4V5h4M9 5v6H5V5h4m10 8v6h-4v-6h4M9 17v2H5v-2h4M21 3h-8v6h8V3zM11 3H3v10h8V3zm10 8h-8v10h8V11zm-10 4H3v6h8v-6z" /> </svg>
                            <span class="side-menu__label">Add Category</span></a>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" href="{{ route('admin.view-product') }}">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"> <path d="M0 0h24v24H0V0z" fill="none" /> <path d="M19 5v2h-4V5h4M9 5v6H5V5h4m10 8v6h-4v-6h4M9 17v2H5v-2h4M21 3h-8v6h8V3zM11 3H3v10h8V3zm10 8h-8v10h8V11zm-10 4H3v6h8v-6z" /> </svg>
                            <span class="side-menu__label">View Product</span></a>
                    </li>
                ...
                <div class="side-app">
                    ...
                    <div class="app-header header">
                        <div class="container-fluid">
                            <div class="d-flex">
                                <a class="header-brand" href="index-2.html">
                                    <img src="/admin_assets/assets/images/brand/logo.png"
                                        class="header-brand-img desktop-lgo" alt="Admintro logo">
                                    <img src="/admin_assets/assets/images/brand/logo1.png"
                                        class="header-brand-img dark-logo" alt="Admintro logo">
                                    <img src="/admin_assets/assets/images/brand/favicon.png"
                                ...
                                <div class="d-flex order-lg-2 ml-auto">
                                    <a href="index.html#" data-toggle="search"
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            <span
                                                                ...
                                                                data-image-src="/admin_assets/assets/images/users/1.jpg"></span>
                                                        </div>
                                                        <div class="d-flex">
                                                            <div class="pl-3">
                                                                <h6 class="mb-1">Jack Wright</h6>
                                                                <p class="fs-13 mb-1">All the best your template awesome
                                                                </p>
                                                ...
                                                <a class="dropdown-item border-bottom">
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            <span
                                                                class="avatar avatar-md brround align-self-center cover-image"
                                                                data-image-src="/admin_assets/assets/images/users/2.jpg"></span>
                                                        </div>
                                                        <div class="d-flex">
                                                            <div class="pl-3">
                                                ...
                                                <a class="dropdown-item border-bottom">
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            <span
                                                                class="avatar avatar-md brround align-self-center cover-image"
                                                                data-image-src="/admin_assets/assets/images/users/3.jpg"></span>
                                                        </div>
                                                        <div class="d-flex">
                                                            <div class="pl-3">
                                                ...
                                                <a class="dropdown-item border-bottom">
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            <span
                                                                class="avatar avatar-md brround align-self-center cover-image"
                                                                data-image-src="/admin_assets/assets/images/users/4.jpg"></span>
                                                        </div>
                                                        <div class="d-flex">
                                                            <div class="pl-3">
                                                ...
                                                <a class="dropdown-item border-bottom">
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            <span
                                                                class="avatar avatar-md brround align-self-center cover-image"
                                                                data-image-src="/admin_assets/assets/images/users/6.jpg"></span>
                                                        </div>
                                                        <div class="d-flex">
                                                            <div class="pl-3">
                                                                <h6 class="mb-1">Stewart Bond</h6>
                                                                <p class="fs-13 mb-1">Your payment invoice is generated
                                                                </p>
                                                                <div class="small text-muted">
                                                                    3 days ago
                                                                </div>
                                                ...
                                                <a class="dropdown-item border-bottom">
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            <span
                                                                class="avatar avatar-md brround align-self-center cover-image"
                                                                data-image-src="/admin_assets/assets/images/users/7.jpg"></span>
                                                        </div>
                                                        <div class="d-flex">
                                                            <div class="pl-3">
                                    ...
                                    <div class="dropdown profile-dropdown">
                                        <a href="index.html#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                                            <span>
                                                <img src="/admin_assets/assets/images/users/2.jpg" alt="img"
            ...
            <div class="container">
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-md-12 col-sm-12 text-center">
                        Copyright © 2020 <a href="index.html#">Admintro</a>. Designed by <a href="index.html#">Spruko
    ...
    <!-- Bootstrap4 js-->
    <script src="/admin_assets/assets/plugins/bootstrap/popper.min.js"></script>
    <script src="/admin_assets/assets/plugins/bootstrap/js/bootstrap.min.js"></script>

    <!--Othercharts js-->
    <script src="/admin_assets/assets/plugins/othercharts/jquery.sparkline.min.js"></script>

    <!-- Circle-progress js-->
    <script src="/admin_assets/assets/js/circle-progress.min.js"></script>

    <!-- Jquery-rating js-->
    <script src="/admin_assets/assets/plugins/rating/jquery.rating-stars.js"></script>

    <!--Sidemenu js-->
    <script src="/admin_assets/assets/plugins/sidemenu/sidemenu.js"></script>

    <!-- P-scroll js-->
    <script src="/admin_assets/assets/plugins/p-scrollbar/p-scrollbar.js"></script>
    <script src="/admin_assets/assets/plugins/p-scrollbar/p-scroll1.js"></script>
    <script src="/admin_assets/assets/plugins/p-scrollbar/p-scroll.js"></script>


    <!--INTERNAL Peitychart js-->
    <script src="/admin_assets/assets/plugins/peitychart/jquery.peity.min.js"></script>
    <script src="/admin_assets/assets/plugins/peitychart/peitychart.init.js"></script>

    <!--INTERNAL Apexchart js-->
    <script src="/admin_assets/assets/js/apexcharts.js"></script>

    <!--INTERNAL ECharts js-->
    <script src="/admin_assets/assets/plugins/echarts/echarts.js"></script>

    <!--INTERNAL Chart js -->
    <script src="/admin_assets/assets/plugins/chart/chart.bundle.js"></script>
    <script src="/admin_assets/assets/plugins/chart/utils.js"></script>

    <!-- INTERNAL Select2 js -->
    <script src="/admin_assets/assets/plugins/select2/select2.full.min.js"></script>
    <script src="/admin_assets/assets/js/select2.js"></script>

    <!--INTERNAL Moment js-->
    <script src="/admin_assets/assets/plugins/moment/moment.js"></script>

    <!--INTERNAL Index js-->
    <script src="/admin_assets/assets/js/index1.js"></script>
    ...
    <!-- Switcher js-->
    <script src="/admin_assets/assets/switcher/js/switcher.js"></script>


</body>

<!-- Mirrored from laravel.spruko.com/admitro/Vertical-IconSidedar-Light/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Oct 2020 02:49:42 GMT -->
